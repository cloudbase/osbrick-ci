...
echo ZUUL_REF=$ZUUL_REF | tee -a /home/jenkins-slave/runs/devstack_params.$ZUUL_UUID.$JOB_TYPE.txt
...
echo FLOATING_IP=$FLOATING_IP | tee -a /home/jenkins-slave/runs/devstack_params.$ZUUL_UUID.$JOB_TYPE.txt
...
run_ssh_cmd_with_retry ubuntu@$FLOATING_IP $DEVSTACK_SSH_KEY "wget http://10.20.1.14:8080/cirros-latest.vhdx -O /home/ubuntu/devstack/files/images/cirros-latest.vhdx"
